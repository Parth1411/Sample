<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWithSP.aspx.cs" Inherits="EFDBFirst.CustomerWithSP" MasterPageFile="~/Master.Master" %>
...
<asp:Content ID="PageMainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#aCustomerWithSP').parent().addClass('active');
