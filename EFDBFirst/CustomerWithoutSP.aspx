<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerWithoutSP.aspx.cs" Inherits="EFDBFirst.CustomerWithoutSP" MasterPageFile="~/Master.Master" %>
...
<asp:Content ID="PageMainContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $('#aCustomerWithoutSP').parent().addClass('active');
